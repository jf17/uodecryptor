...
namespace UOD
{
    public partial class Form1 : Form
    {
        ...
        public static long FileSize;    // Length of the client read into the byte array
        ...
        {
            // Check client.exe is in app's working directory
            if (!File.Exists(Path.Combine(m_ClientFileLocation, CLIENT)))
            {
